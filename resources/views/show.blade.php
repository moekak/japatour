    ...
    <div class="main-content">
        ...
        <div class="content-left">
            ...
            <div class="tour-preview">
                <img src="{{ asset('storage/' . $tour->gallery_images[0]) }}" alt="{{ $tour->title }}"
                    class="preview-main">
                    ...
                    <div class="itinerary-days">
                        ...
                        <div class="itinerary-day">
                            ...
                            <div class="itinerary-day-left">
                                ...
                                <div class="day-actions">
                                    ...
                                    <div class="day-action-btn map">
                                        ...
                                        <span><a href="{{$itinerary["map"]}}" target="_blank"
                                                rel="noopener noreferrer">View on Map</a></span>
                                    </div>
                                    @endif
                            ...
                            <div class="itinerary-day-right">
                                <img src="{{ asset('storage/' . $itinerary["itinerary_image"]) }}"
                                    alt="{{ $tour->title }}" class="itinerary-day-image">
                                <div class="day-schedule">
                                    ...
                                    <div class="schedule-item">
                                        {{-- <div class="schedule-time">{{$schedule["time"]}}
                                    </div> --}}
                                    <div class="schedule-description">{{$schedule["description"]}}
                                    </div>
                                </div>
                                @endforeach
                            </div>
            ...
            <div class="reviews-header">
                ...
                <div class="avg-rating">
                    ...
                    <div class="rating-stars">
                        ...
                        for($i = 0; $i < $integerPart; $i ++){ echo '<i class="fas fa-star"></i>' ; }
                            @endphp @if ($decimalPart> 0)
                ...
                <div class="review-card">
                    ...
                    <div class="reviewer-rating">
                        ...
                        for($i = 0; $i < $review->rate; $i++){
                            ...
                            for($i = 0; $i < $emptyStar; $i++){ echo '<i class="fa-regular fa-star"></i>'
                                ; } @endphp </div>
...
<section class="cta-section">
    <div class="cta-content">
        ...
        <p class="cta-text">Book this tour today and create memories that will last a lifetime. Limited spots
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const availableDates = {
            !!json_encode($tour - > available_dates) !!
        };
        ...
        function renderCalendar(year, month) {
            ...
            const realToday = new Date(currentDate.getFullYear(), currentDate.getMonth(), currentDate
                .getDate());
            ...
            for (let day = 1; day <= daysInMonth; day++) {
                ...
                dateElement.addEventListener("click", () => {
                    window.location.href =
                        `/tour/book/${tourId}/${dateElement.dataset.date}`;
                })
            }
        }
        ...
        function selectDate(date) {
            ...
            document.querySelectorAll('.date').forEach(el => {
                if (!el.classList.contains('empty') &&
                    new Date(`${currentYear}-${currentMonthIndex+1}-${el.textContent}`)
                    .toISOString().split('T')[0] === date) {
    ...
    function enhanceGallery() {
        ...
        const galleryImages = {
            !!json_encode($tour - > gallery_images) !!
        };
    ...
    document.querySelectorAll('.day-action-btn.details').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            if (computedStyle.display === 'none') {
                ...
                this.innerHTML =
                    '<i class="fas fa-minus-circle"></i><span>Hide Itinerary</span>';
            } else {
                scheduleElement.style.display = 'none';
                this.innerHTML =
                    '<i class="fas fa-info-circle"></i><span>Show Itinerary</span>';
            }
        });
    });
</script>
