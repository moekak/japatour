...
<head>
      ...
      <title>Edit Blog Post - ShogunTours</title>
            ...
            <div class="container mx-auto px-6 max-w-6xl">
                        ...
                        <div class="flex items-center justify-between">
                              <div>
                                    <div class="flex items-center gap-2 text-sm text-gray-600 mb-4">
                                          <a href="{{route("blog.list")}}" class="hover:text-[#e92929] transition-colors">Blog</a>
                  ...
                  <div class="space-y-8">
                                          ...
                                          <div class="flex space-x-6 pt-2">
                                                <label class="flex items-center space-x-2">
                                                      <input type="radio" id="featured-no" name="is_featured" value="0" 
                                                            class="w-4 h-4 text-[#e92929] border-gray-300 focus:ring-[#e92929] focus:ring-2" {{!$blog->is_featured ? "checked" : ""}} checked>
                                                      <span class="text-sm text-gray-700">No</span>
                                                </label>
                                                <label class="flex items-center space-x-2">
                                                      <input type="radio" id="featured-yes" name="is_featured" value="1" {{$blog->is_featured ? "checked" : ""}}
                        ...
                        <div class="bg-white rounded-xl shadow-sm p-8">
                              ...
                              <div id="image-upload-area" class="hidden border-2 border-dashed border-gray-300 rounded-lg p-12 text-center hover:border-[#e92929] transition-colors cursor-pointer">
                              ...
                              <div id="image-preview" class="mt-4">
                                    <img id="preview-img" src="{{ asset('storage/' . $blog->featured_image) }}" alt="Preview" class="w-full h-64 object-cover rounded-lg">
...
![Image alt text](image-url.jpg)"
                                    class="w-full px-6 py-6 border border-gray-300 border-t-0 rounded-b-lg focus:border-[#e92929] focus:outline-none focus:ring-2 focus:ring-[#e92929]/20 transition-all editor-content resize-none text-base leading-relaxed">{{$blog->content}}</textarea>
                        </div>
                        ...
                        <div class="bg-white rounded-xl shadow-sm p-8">
                              <div class="flex justify-between items-center">
                                    <div class="text-gray-500">
                                          ...
                                          All changes will be saved when you update the post
                                    </div>
                                    <button type="button" onclick="publishPost()" 
    ...
    <script>
      ...
      const publishPost = async() => {
            ...
            if(data.status == "error"){
                  ...
                  localStorage.setItem("success", "Successfully edited the blog post!")
