...
<body>
      <div class="relative flex size-full min-h-screen flex-col bg-white group/design-root overflow-x-hidden"
            ...
            <!-- Minimal Header -->
            <header class="fixed top-0 left-0 right-0 bg-white/80 backdrop-blur-md z-50 transition-all duration-300"
                  id="header">
                  <div class="container mx-auto px-6 py-4">
                        <div class="flex items-center justify-between">
                              ...
                              <nav class="hidden md:flex items-center gap-8">
                                    <a href="#overview"
                                          class="text-gray-600 hover:text-[#e92929] transition-colors test-base font-medium">Overview</a>
                                    <a href="#itinerary"
                                          class="text-gray-600 hover:text-[#e92929] transition-colors test-base font-medium">Itinerary</a>
                                    <a href="#gallery"
                                          class="text-gray-600 hover:text-[#e92929] transition-colors test-base font-medium">Gallery</a>
                                    <a href="#reviews"
                                          class="text-gray-600 hover:text-[#e92929] transition-colors test-base font-medium">Reviews</a>
                              </nav>
                              <button
                                    class="bg-[#e92929] text-white px-6 py-2.5 rounded-full font-medium hover:bg-[#d61f1f] transition-all transform hover:scale-105">
                                    Book Now
                              </button>
                        </div>
                  </div>
            ...
            <section class="relative h-screen flex items-center justify-center">
                  <div class="absolute inset-0">
                        <img src="https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?w=1920&h=1080&fit=crop"
                              alt="Tokyo City" class="w-full h-full object-cover">
                              ...
                              <div>
                                    ...
                                    <div class="space-y-4 mb-8">
                                          <div class="flex items-start gap-4">
                                                ...
                                                <div>
                                                      ...
                                                      <p class="text-gray-600 test-base">Visit Tokyo's most sacred sites
                                                            including the famous Senso-ji Temple</p>
                                                </div>
                                          </div>
                                          ...
                                          <div class="flex items-start gap-4">
                                                ...
                                                <div>
                                                      ...
                                                      <p class="text-gray-600 test-base">Experience the energy of
                                                            Shibuya
                                                            Crossing and panoramic city views</p>
                                                </div>
                                          </div>
                                          ...
                                          <div class="flex items-start gap-4">
                                                ...
                                                <div>
                                                      ...
                                                      <p class="text-gray-600 test-base">Savor traditional Japanese
                                                            lunch
                                                            at a hidden local restaurant</p>
                                                </div>
                                          </div>
                                    </div>
                                    ...
                                    <!-- <div class="flex gap-4">
                                          <div class="text-center">
                                                ...
                                                <p class="text-gray-600 test-base">Years Experience</p>
                                          </div>
                                          <div class="text-center border-x px-6">
                                                <div class="text-2xl font-bold text-[#e92929]">10+</div>
                                                <p class="text-gray-600 test-base">Expert Guides</p>
                                          </div>
                                          <div class="text-center">
                                                <div class="text-2xl font-bold text-[#e92929]">24/7</div>
                                                <p class="text-gray-600 test-base">Support</p>
                                          </div>
                                    </div> -->
                              </div>
                              ...
                              <div class="relative">
                                    ...
                                    <!-- <div class="absolute -bottom-6 -left-6 bg-white p-6 rounded-xl shadow-xl">
                                          <div class="flex items-center gap-4">
                                                <div
                                                      class="w-16 h-16 bg-[#e92929]/10 rounded-full flex items-center justify-center">
                              ...
                              <div class="bg-white rounded-2xl overflow-hidden smooth-shadow-lg card-hover cursor-pointer"
                                    ...
                                    <div class="relative h-48 overflow-hidden">
                                          ...
                                          <div class="absolute top-4 left-4">
                                                <span
                                                      class="bg-gradient-to-r from-[#e92929] to-[#ff6b6b] text-white px-3 py-1 rounded-full text-xs font-semibold">
                                                      BESTSELLER
                                                </span>
                                          </div>
            ...
            <section id="gallery" class="py-20">
                  <div class="container mx-auto px-6">
                        ...
                        <div class="grid grid-cols-3 gap-4 max-w-[1100px] mx-auto">
                              ...
                              <div class="space-y-4">
                                    <img src="https://images.unsplash.com/photo-1554797589-7241bb691973?w=400&h=300&fit=crop"
                                          alt="Gallery"
                                          class="rounded-lg shadow-lg hover:shadow-xl transition-shadow cursor-pointer">
                                    <img src="https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?w=400&h=500&fit=crop"
                                          alt="Gallery"
                                          class="rounded-lg shadow-lg hover:shadow-xl transition-shadow cursor-pointer">
                              </div>
                              <div class="space-y-4">
                                    <img src="https://images.unsplash.com/photo-1555400038-63f5ba517a47?w=400&h=400&fit=crop"
                                          alt="Gallery"
                                          class="rounded-lg shadow-lg hover:shadow-xl transition-shadow cursor-pointer">
                                    <img src="https://images.unsplash.com/photo-1490761668535-35497054764d?w=400&h=400&fit=crop"
                                          alt="Gallery"
                                          class="rounded-lg shadow-lg hover:shadow-xl transition-shadow cursor-pointer">
                              </div>
                        </div>
            ...
            <section class="py-20">
                  <div class="container mx-auto px-6">
                        <div
                              class="bg-gradient-to-r from-[#e92929] to-[#f04040] rounded-2xl p-8 md:p-12 text-white relative overflow-hidden">
                              ...
                              <div class="relative z-10 max-w-4xl mx-auto text-center">
                                    ...
                                    <div class="bg-white/20 backdrop-blur-sm rounded-xl p-6 md:p-8 max-w-2xl mx-auto">
                                          <div class="grid md:grid-cols-2 gap-6 mb-6">
                                                <div class="text-left">
                                                      <label class="test-base opacity-80 block mb-2">Select Date</label>
                                                      <div
                                                            class="bg-white/20 rounded-lg px-4 py-3 flex items-center justify-between cursor-pointer hover:bg-white/30 transition-colors">
                                                            <span>April 15, 2025</span>
                                                            <i class="fas fa-calendar-alt"></i>
                                                      </div>
                                                </div>
                                                <div class="text-left">
                                                      <label class="test-base opacity-80 block mb-2">Number of
                                                            Guests</label>
                                                      <div
                                                            class="bg-white/20 rounded-lg px-4 py-3 flex items-center justify-between">
                                                            <button
                                                                  class="hover:bg-white/20 w-8 h-8 rounded-full transition-colors">-</button>
                                                            <span>2 Adults</span>
                                                            <button
                                                                  class="hover:bg-white/20 w-8 h-8 rounded-full transition-colors">+</button>
                                                      </div>
                                          ...
                                          <div class="flex items-center justify-between mb-6">
                                                <div class="text-left">
                                                      <p class="test-base opacity-80">Total Price</p>
                                                      <p class="text-3xl font-bold">¥24,000</p>
                                                      <p class="test-base opacity-80 line-through">¥30,000</p>
                                                </div>
                                                <button
                                                      class="bg-white text-[#e92929] px-8 py-4 rounded-full font-bold hover:scale-105 transition-transform">
                                                      Book Now & Save 20%
                                                </button>
                                          </div>

                                          <p class="test-base opacity-80">
                  ...
                  <div class="container mx-auto px-6 max-w-3xl">
                        ...
                        <div class="space-y-4">
                              <div class="bg-white rounded-lg shadow-sm">
                                    ...
                                    <div class="hidden px-6 pb-4">
                                          <p class="text-gray-600">
                                                The tour includes hotel pickup/drop-off, professional English-speaking
                                                guide,
                              ...
                              <div class="bg-white rounded-lg shadow-sm">
                                    ...
                                    <div class="hidden px-6 pb-4">
                                          <p class="text-gray-600">
                                                Yes! This tour is family-friendly. Children under 5 join free, and we
                                                provide
                              ...
                              <div class="bg-white rounded-lg shadow-sm">
                                    ...
                                    <div class="hidden px-6 pb-4">
                                          <p class="text-gray-600">
                                                Comfortable walking shoes, camera, sunscreen, and weather-appropriate
                                                clothing.
                    ...
                    <div class="flex-1 pb-8">
                        <div class="bg-gray-50 rounded-xl p-4">
                            <div class="flex justify-between items-start mb-2">
                                ...
                                <span class="test-base text-[#e92929] font-medium">${item.time}</span>
                            </div>
                            <p class="text-gray-600 test-base">${item.description}</p>
                        </div>
                    </div>
                </div>
            `).join('');
                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-6">
                            <div class="bg-gray-50 rounded-xl p-4">
                                ...
                                <p class="text-gray-600 test-base">Your hotel lobby or designated meeting spot</p>
                            </div>
                            <div class="bg-gray-50 rounded-xl p-4">
