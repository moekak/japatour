            ...
            <div class="container mx-auto px-6 max-w-[1100px]">
                  ...
                  <div class="space-y-6">
                        ...
                        <div class="space-y-6">
                              ...
                              <div class="bg-white rounded-xl shadow-sm p-6 relative">
                                    ...
                                    <div class="bg-gray-50 rounded-lg p-5 mb-6">
                                          ...
                                          <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                                                ...
                                                <div>
                                                      <label class="block text-sm font-medium text-gray-700 mb-1">Tour
                                                            Type *</label>
                                                      <select
                                                            class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:border-[#e92929] focus:outline-none focus:ring-2 focus:ring-[#e92929]/20 transition-all text-sm">
                                                ...
                                                <div>
                                                      <label class="block text-sm font-medium text-gray-700 mb-1">Meeting
                                                            Point *</label>
                                                      <input type="text"
                                                ...
                                                <div>
                                                      <label class="block text-sm font-medium text-gray-700 mb-1">Adult
                                                            Price (¥) *</label>
                                                ...
                                                <div>
                                                      <label class="block text-sm font-medium text-gray-700 mb-1">Child
                                                            Price (¥)</label>
                                    ...
                                    <div class="space-y-4">
                                          ...
                                          <div class="border border-gray-200 rounded-lg overflow-hidden">
                                                <div class="bg-gray-50 p-4 border-b border-gray-200">
                                                      <div class="flex items-center justify-between">
                                                            <h5 class="font-semibold text-gray-800">Itinerary Item #1
                                                            </h5>
                                                ...
                                                <div class="p-4 space-y-4">
                                                      <div class="grid md:grid-cols-3 gap-4">
                                                            ...
                                                            <div class="md:col-span-2">
                                                                  <label
                                                                        class="block text-sm font-medium text-gray-700 mb-1">Activity
                                                                        Title</label>
                                                                  <input type="text"
                                                      ...
                                                      <div>
                                                            ...
                                                            <div
                                                                  ...
                                                                  <i
                                                                        class="fas fa-image text-2xl text-gray-400 mb-2"></i>
                                                                  <p class="text-xs text-gray-500">Upload activity image
                                                                  </p>
                                                            </div>
                                                      </div>
                              ...
                              <button
                                    class="w-full py-4 border-2 border-dashed border-[#e92929] rounded-xl text-[#e92929] hover:bg-[#e92929]/5 transition-colors flex items-center justify-center gap-2 font-medium">
                                    <i class="fas fa-plus-circle"></i>
                  ...
                  <div class="mt-8 flex items-center justify-between bg-white rounded-xl shadow-sm p-6">
                        ...
                        <div class="flex items-center gap-3">
                              ...
                              <button
                                    class="px-6 py-2.5 bg-gray-200 text-gray-700 hover:bg-gray-300 rounded-lg transition-colors font-medium">
                                    Save as Draft
                              </button>
                              <button
