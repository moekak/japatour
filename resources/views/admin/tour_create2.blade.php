        ...
        <div class="container mx-auto px-6 max-w-[1100px]">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <div class="space-y-5">
                        <div>
                            ...
                            <input type="text" placeholder="e.g., Tokyo City Highlights Tour" 
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="e.g., An unforgettable journey through Japan's vibrant capital" 
                                   class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-[#e92929] focus:outline-none focus:ring-2 focus:ring-[#e92929]/20 transition-all">
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Badge Label</label>
                            <select class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-[#e92929] focus:outline-none focus:ring-2 focus:ring-[#e92929]/20 transition-all">
                ...
                <div class="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-[#e92929] transition-colors cursor-pointer">
                        ...
                        <button class="px-6 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors font-medium text-sm">
                            Select Hero Image
                        </button>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <div class="space-y-5">
                        <div>
                            ...
                            <input type="text" placeholder="e.g., Experience Tokyo Like Never Before" 
                                   class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-[#e92929] focus:outline-none focus:ring-2 focus:ring-[#e92929]/20 transition-all">
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Overview Description *</label>
                            <textarea rows="4" placeholder="Describe what makes this tour special..." 
                ...
                <div class="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <div class="space-y-4">
                        <div class="bg-gray-50 rounded-lg p-4">
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    <input type="text" placeholder="Highlight title (e.g., Ancient Temples & Shrines)" 
                                    ...
                                    <textarea rows="2" placeholder="Brief description of this highlight..." 
                    ...
                    <button class="mt-4 w-full py-3 border-2 border-dashed border-gray-300 rounded-lg text-gray-600 hover:border-[#e92929] hover:text-[#e92929] transition-colors flex items-center justify-center gap-2">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm p-6 relative">
                        <div class="absolute top-6 right-6">
                            <button class="p-2 text-gray-400 hover:text-red-500 transition-colors" title="Delete this itinerary">
                                <i class="fas fa-trash"></i>
                            </button>
                        </div>
                        ...
                        <div class="bg-gray-50 rounded-lg p-5 mb-6">
                            ...
                            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <input type="number" placeholder="e.g., 8" min="1" max="24"
                                ...
                                <div>
                                    ...
                                    <input type="number" placeholder="e.g., 15" min="1" max="50"
                                           class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:border-[#e92929] focus:outline-none focus:ring-2 focus:ring-[#e92929]/20 transition-all text-sm">
                                </div>
                                
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Tour Type *</label>
                                    <select class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:border-[#e92929] focus:outline-none focus:ring-2 focus:ring-[#e92929]/20 transition-all text-sm">
                                ...
                                <div>
                                    ...
                                    <input type="text" placeholder="e.g., Hotel lobby or JR Shibuya Station" 
                                           class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:border-[#e92929] focus:outline-none focus:ring-2 focus:ring-[#e92929]/20 transition-all text-sm">
                                </div>
                                
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Adult Price (¥) *</label>
                                    <input type="number" placeholder="e.g., 12000" min="0"
                                           class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:border-[#e92929] focus:outline-none focus:ring-2 focus:ring-[#e92929]/20 transition-all text-sm">
                                </div>
                                
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Child Price (¥)</label>
                                    <input type="number" placeholder="e.g., 6000" min="0"
                                           class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:border-[#e92929] focus:outline-none focus:ring-2 focus:ring-[#e92929]/20 transition-all text-sm">
                                </div>
                            </div>
                            ...
                            <div class="mt-4">
                                ...
                                <div class="flex flex-wrap gap-3">
                                    <label class="flex items-center gap-2 cursor-pointer">
                                        <input type="checkbox" checked class="w-4 h-4 text-[#e92929] rounded focus:ring-[#e92929] focus:ring-2">
                                    ...
                                    <label class="flex items-center gap-2 cursor-pointer">
                                        <input type="checkbox" class="w-4 h-4 text-[#e92929] rounded focus:ring-[#e92929] focus:ring-2">
                                ...
                                <div class="p-4 space-y-4">
                                    <div class="grid md:grid-cols-3 gap-4">
                                        ...
                                        <div class="md:col-span-2">
                                            ...
                                            <input type="text" placeholder="e.g., Senso-ji Temple Visit" 
                                                   class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:border-[#e92929] focus:outline-none focus:ring-2 focus:ring-[#e92929]/20 transition-all text-sm">
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-2">Main Image for this Activity</label>
                                        <div class="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-[#e92929] transition-colors cursor-pointer">
                                    ...
                                    <div>
                                        ...
                                        <div class="space-y-2">
                                            <div class="flex items-center gap-2">
                                                <input type="text" placeholder="e.g., Tokyo's oldest Buddhist temple" 
                                            ...
                                            <button class="text-[#e92929] hover:text-[#d61f1f] text-sm font-medium flex items-center gap-1">
                    ...
                    <button class="w-full py-4 border-2 border-dashed border-[#e92929] rounded-xl text-[#e92929] hover:bg-[#e92929]/5 transition-colors flex items-center justify-center gap-2 font-medium">
                        <i class="fas fa-plus-circle"></i>
            ...
            <div class="mt-8 flex items-center justify-between bg-white rounded-xl shadow-sm p-6">
                ...
                <div class="flex items-center gap-3">
                    <button class="px-6 py-2.5 text-gray-700 hover:bg-gray-100 rounded-lg transition-colors font-medium">
                        Cancel
                    </button>
                    <button class="px-6 py-2.5 bg-gray-200 text-gray-700 hover:bg-gray-300 rounded-lg transition-colors font-medium">
                        Save as Draft
                    </button>
                    <button class="px-6 py-2.5 bg-gradient-to-r from-[#e92929] to-[#ff6b6b] text-white rounded-lg hover:shadow-lg transition-all font-medium">
                        Publish Tour
                    </button>
                </div>
            </div>
