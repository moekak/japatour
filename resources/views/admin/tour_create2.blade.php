                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div class="flex flex-wrap gap-3">
                                            <label class="flex items-center gap-2 cursor-pointer">
                                                ...
                                                <span
                                                    class="text-sm text-gray-700">English</span>
                                            </label>
                                            <label class="flex items-center gap-2 cursor-pointer">
                                                <input type="checkbox" checked
                                                    name="itinerary[0][languages][]"
                                                    class="w-4 h-4 text-[#e92929] rounded focus:ring-[#e92929] focus:ring-2">
                                                <span
                                                    class="text-sm text-gray-700">Japanese</span>
                                            </label>
                                            <label class="flex items-center gap-2 cursor-pointer">
                                                <input type="checkbox"
                                                    name="itinerary[0][languages][]"
                                                    class="w-4 h-4 text-[#e92929] rounded focus:ring-[#e92929] focus:ring-2">
                                                <span
                                                    class="text-sm text-gray-700">Chinese</span>
                                            </label>
                                            <label class="flex items-center gap-2 cursor-pointer">
                                                <input type="checkbox"
                                                    name="itinerary[0][languages][]"
                                                    class="w-4 h-4 text-[#e92929] rounded focus:ring-[#e92929] focus:ring-2">
                                                <span
                                                    class="text-sm text-gray-700">Korean</span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="border border-gray-200 rounded-lg overflow-hidden">
                                        ...
                                        <div class="p-4 space-y-4">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            class="md:col-span-2">
                                                                            <input type="text"
                                                                                name="itinerary[0][activity_title][0]"
                                            ...
                                            <div>
                                                <label
                                                    class="block text-sm font-medium text-gray-700 mb-2">Main
                                                ...
                                                <div
                                                    ...
                                                    <p class="text-xs text-gray-500">Upload
                                                        activity image</p>
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                <label
                                                    class="block text-sm font-medium text-gray-700 mb-2">Activity
                                                    Highlights</label>
                                                <div
                                                    class="space-y-2 itinerary_highlight-wrapper">
