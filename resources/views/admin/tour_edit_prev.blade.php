                                                      ...
                                                      <div class="m-8">
                                                            ...
                                                            <div class="flex flex-wrap gap-3">
                                                                  @php
                                                                        ...
                                                                        $itineraryLanguages = $itinerary["languages"];
                                                                        $languageIds = array_map(function($language){
                                                                              return $language; 
                                                                        }, $itineraryLanguages);
                                                                        

                                                                        // print_r($selectedLanguages);
                                                                        // exit;
                                                      ...
                                                      <div class="border border-gray-200 rounded-lg overflow-hidden mt-8">
                                                            ...
                                                            @else
                                                                  ...
                                                                  <div
                                                                        ...
                                                                        <input type="file" name="itinerary[{{$itineraryIndex}}][image]" id="itinerary_{{$itineraryIndex}}" class="hidden">
                                                                        <input type="hidden" name="itinerary[{{$itineraryIndex}}][image]" id="itinerary_{{$itineraryIndex}}" class="hidden" value="{{$itinerary['image']}}">
                                                                  </div>
                                                            @endif
                                                      </div>
