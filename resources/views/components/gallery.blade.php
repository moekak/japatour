...
<script>
 ...
 <div class="bg-white rounded-xl shadow-sm p-6">
      ...
      <div class="grid grid-cols-3 gap-4 max-w-[1100px] mx-auto">
            ...
            <div class="space-y-4">
                  <!-- Image 1 - Large -->
                  <x-gallery-image-upload index=0 height="500"/>
                  <!-- Image 2 - Medium -->
                  <x-gallery-image-upload index=1 height="300"/>
            </div>

            <!-- Column 2 -->
            <div class="space-y-4">
                  <!-- Image 3 - Medium -->
                  <x-gallery-image-upload index=2 height="300"/>
                  <!-- Image 4 - Large -->
                  <x-gallery-image-upload index=3 height="500"/>
            ...
            <div class="space-y-4">
                  <!-- Image 5 - Square -->
                  <x-gallery-image-upload index=4 height="400"/>
                  
                  <!-- Image 6 - Square -->
                  <x-gallery-image-upload index=5 height="400"/>
            </div>
      </div>
</div>
