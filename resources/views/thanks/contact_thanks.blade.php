                                    ...
                                    <div class="bg-gradient-to-r from-[#e92929] to-[#f04040] rounded-2xl p-6 sm:p-8 lg:p-12 text-white relative overflow-hidden">
                                          ...
                                          <div class="relative z-10 text-center">
                                                ...
                                                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                                                      <a href="{{route("tours")}}" class="bg-white text-[#e92929] px-6 sm:px-8 py-3 sm:py-4 rounded-full font-bold hover:scale-105 transition-transform text-base">
                                                            View All Tours
                                                      </a>
                                                      <a href="https://www.instagram.com/shoguntoursjapan/" class="bg-white/20 backdrop-blur-sm text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full font-bold hover:bg-white/30 transition-colors text-base">
                                                            See Our Gallery
                                                      </a>
                                                </div>
                                          </div>
