      ...
      <div class="layout-container flex h-full grow flex-col">
        ...
        <header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#f3e7e7] px-10 py-3 sticky top-0 bg-[#fcf8f8] z-50">
          <div class="flex items-center gap-4 text-[#1b0e0e]">
            ...
            <h2 class="text-[#1b0e0e] text-lg font-bold leading-tight tracking-[-0.015em]">Japatour</h2>
          </div>
          <div class="flex flex-1 justify-end gap-8">
            <div class="flex items-center gap-9">
              <a class="text-[#1b0e0e] text-sm font-medium leading-normal hover:text-[#e92929] transition-colors" href="#tours">Tours</a>
              <a class="text-[#1b0e0e] text-sm font-medium leading-normal hover:text-[#e92929] transition-colors" href="#instagram">Gallery</a>
              <a class="text-[#1b0e0e] text-sm font-medium leading-normal hover:text-[#e92929] transition-colors" href="#blog">Blog</a>
              <a class="text-[#1b0e0e] text-sm font-medium leading-normal hover:text-[#e92929] transition-colors" href="#faq">FAQ</a>
            ...
            <div class="@container">
              <div class="@[480px]:p-4">
                <div
                  ...
                  style='background-image: linear-gradient(rgba(0, 0, 0, 0.1) 0%, rgba(0, 0, 0, 0.4) 100%), url("https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1200&h=600&fit=crop");'
                >
        ...
        <section id="tours" class="flex justify-center py-12">
          <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
            ...
            <div id="destinations-section">
              <h2 class="text-[#1b0e0e] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">Popular Destinations</h2>
              <p class="text-[#994d4d] text-sm font-normal leading-normal px-4 pb-3">Choose your destination and explore our amazing tours</p>
              
              <!-- Filter Tabs -->
              <div class="flex flex-wrap gap-2 px-4 pb-3">
                <button class="filter-tab active px-4 py-2 rounded-lg bg-[#e92929] text-white text-sm font-medium transition-all hover:bg-[#d61f1f]" onclick="filterDestinations('all')">All Destinations</button>
                {{-- <button class="filter-tab px-4 py-2 rounded-lg bg-[#f3e7e7] text-[#1b0e0e] text-sm font-medium transition-all hover:bg-[#e7d0d0]" onclick="filterDestinations('kanto')">Kanto Region</button>
                <button class="filter-tab px-4 py-2 rounded-lg bg-[#f3e7e7] text-[#1b0e0e] text-sm font-medium transition-all hover:bg-[#e7d0d0]" onclick="filterDestinations('kansai')">Kansai Region</button>
                <button class="filter-tab px-4 py-2 rounded-lg bg-[#f3e7e7] text-[#1b0e0e] text-sm font-medium transition-all hover:bg-[#e7d0d0]" onclick="filterDestinations('other')">Other Regions</button> --}}
              </div>

              <!-- Destinations Grid -->
              <div class="grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-4 p-4">
                @foreach ($categories as $category)
                    <div class="destination-card relative overflow-hidden rounded-lg cursor-pointer group" data-region="kanto" onclick="showTours('{{$category->category}}')">
                  <img src="/img/{{$category->category}}_category.jpg" alt="{{$category->category}}" class="w-full h-48 object-cover">
                  <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent group-hover:from-black/80 transition-all">
                    <div class="absolute bottom-0 left-0 right-0 p-4 text-white">
                      <h3 class="text-lg font-bold">{{$category->category}}</h3>
                      <p class="text-sm opacity-90"><i class="fas fa-map-marked-alt mr-1"></i>{{$category->tours_count}} Tours</p>
                    </div>
                  </div>
                </div>
                @endforeach
            ...
            <div id="tours-list-section" class="hidden">
              <div class="flex items-center justify-between px-4 pb-3 pt-5">
                ...
                <button class="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#f3e7e7] text-[#1b0e0e] text-sm font-medium hover:bg-[#e7d0d0] transition-colors" onclick="showDestinations()">
        ...
        <section id="instagram" class="flex justify-center py-12 bg-[#f3e7e7]">
            <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
                <h2 class="text-[#1b0e0e] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">Follow Our Adventures</h2>
                <!-- LightWidget WIDGET --><script src="https://cdn.lightwidget.com/widgets/lightwidget.js"></script><iframe src="//lightwidget.com/widgets/863f9f26e66753ad8686944865a5fb20.html" scrolling="no" allowtransparency="true" class="lightwidget-widget" style="width:100%;border:0;overflow:hidden;"></iframe>
        </section>

        <!-- Blog Section -->
        <section id="blog" class="flex justify-center py-12">
          <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
            <h2 class="text-[#1b0e0e] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">Latest Articles</h2>
            <div class="p-4">
              <div class="flex items-stretch justify-between gap-4 rounded-lg hover:bg-[#f3e7e7] transition-colors p-4">
                <div class="flex flex-[2_2_0px] flex-col gap-4">
                  <div class="flex flex-col gap-1">
                    <p class="text-[#1b0e0e] text-base font-bold leading-tight">Exploring the Hidden Gems of the Pacific Northwest</p>
                    <p class="text-[#994d4d] text-sm font-normal leading-normal">
                      Discover the untouched beauty of the Pacific Northwest, from its lush rainforests to its rugged coastlines. This guide takes you off the beaten path to find
                      secluded spots and breathtaking views.
                    </p>
                  </div>
                  <button
                    class="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-8 px-4 flex-row-reverse bg-[#f3e7e7] text-[#1b0e0e] text-sm font-medium leading-normal w-fit hover:bg-[#e7d0d0] transition-colors"
                  >
            ...
            <div class="p-4">
              <div class="flex items-stretch justify-between gap-4 rounded-lg hover:bg-[#f3e7e7] transition-colors p-4">
                <div class="flex flex-[2_2_0px] flex-col gap-4">
                  <div class="flex flex-col gap-1">
                    <p class="text-[#1b0e0e] text-base font-bold leading-tight">A Foodie's Journey Through Southern Italy</p>
                    <p class="text-[#994d4d] text-sm font-normal leading-normal">
                      Embark on a culinary adventure through Southern Italy, where every meal is a celebration of local flavors and traditions. From pasta making in Naples to wine
            ...
            <div class="p-4">
              <div class="flex items-stretch justify-between gap-4 rounded-lg hover:bg-[#f3e7e7] transition-colors p-4">
                <div class="flex flex-[2_2_0px] flex-col gap-4">
                  <div class="flex flex-col gap-1">
                    <p class="text-[#1b0e0e] text-base font-bold leading-tight">The Ultimate Guide to Backpacking in Southeast Asia</p>
                    <p class="text-[#994d4d] text-sm font-normal leading-normal">
                      Plan your backpacking trip through Southeast Asia with this comprehensive guide. Learn about the best routes, must-see destinations, and tips for budget
        ...
        <section id="faq" class="flex justify-center py-12 bg-[#f3e7e7]">
          <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
            <h2 class="text-[#1b0e0e] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">Frequently Asked Questions</h2>
            <div class="flex flex-col p-4 gap-3">
              <details class="flex flex-col rounded-lg border border-[#e7d0d0] bg-[#fcf8f8] px-[15px] py-[7px] group">
                <summary class="flex cursor-pointer items-center justify-between gap-6 py-2">
                  <p class="text-[#1b0e0e] text-sm font-medium leading-normal">What types of tours do you offer?</p>
                  <div class="text-[#1b0e0e] group-open:rotate-180 transition-transform" data-icon="CaretDown" data-size="20px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor" viewBox="0 0 256 256">
                      <path d="M213.66,101.66l-80,80a8,8,0,0,1-11.32,0l-80-80A8,8,0,0,1,53.66,90.34L128,164.69l74.34-74.35a8,8,0,0,1,11.32,11.32Z"></path>
                    </svg>
                  </div>
                </summary>
                <p class="text-[#994d4d] text-sm font-normal leading-normal pb-2">We offer a wide variety of tours including mountain hiking expeditions, coastal explorations, cultural immersion journeys, wildlife safaris, city discovery tours, and tropical island getaways. Each tour is carefully designed to provide unique experiences and lasting memories.</p>
              </details>
              <details class="flex flex-col rounded-lg border border-[#e7d0d0] bg-[#fcf8f8] px-[15px] py-[7px] group">
                <summary class="flex cursor-pointer items-center justify-between gap-6 py-2">
                  <p class="text-[#1b0e0e] text-sm font-medium leading-normal">How do I book a tour?</p>
                  <div class="text-[#1b0e0e] group-open:rotate-180 transition-transform" data-icon="CaretDown" data-size="20px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor" viewBox="0 0 256 256">
                      <path d="M213.66,101.66l-80,80a8,8,0,0,1-11.32,0l-80-80A8,8,0,0,1,53.66,90.34L128,164.69l74.34-74.35a8,8,0,0,1,11.32,11.32Z"></path>
                    </svg>
                ...
                <p class="text-[#994d4d] text-sm font-normal leading-normal pb-2">Booking is easy! Simply click the "Book Now" button on any tour page, select your preferred dates, and follow the secure checkout process. You can also contact us directly via phone or email for personalized assistance.</p>
              </details>
              <details class="flex flex-col rounded-lg border border-[#e7d0d0] bg-[#fcf8f8] px-[15px] py-[7px] group">
                <summary class="flex cursor-pointer items-center justify-between gap-6 py-2">
                  <p class="text-[#1b0e0e] text-sm font-medium leading-normal">What is included in the tour price?</p>
                  <div class="text-[#1b0e0e] group-open:rotate-180 transition-transform" data-icon="CaretDown" data-size="20px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor" viewBox="0 0 256 256">
                      <path d="M213.66,101.66l-80,80a8,8,0,0,1-11.32,0l-80-80A8,8,0,0,1,53.66,90.34L128,164.69l74.34-74.35a8,8,0,0,1,11.32,11.32Z"></path>
                    </svg>
                ...
                <p class="text-[#994d4d] text-sm font-normal leading-normal pb-2">Our tour prices typically include accommodation, most meals, professional guides, entrance fees to attractions, and ground transportation. International flights are not included unless specified. Each tour page provides detailed information about inclusions.</p>
              </details>
              <details class="flex flex-col rounded-lg border border-[#e7d0d0] bg-[#fcf8f8] px-[15px] py-[7px] group">
                <summary class="flex cursor-pointer items-center justify-between gap-6 py-2">
                  <p class="text-[#1b0e0e] text-sm font-medium leading-normal">What is your cancellation policy?</p>
                  <div class="text-[#1b0e0e] group-open:rotate-180 transition-transform" data-icon="CaretDown" data-size="20px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor" viewBox="0 0 256 256">
                      <path d="M213.66,101.66l-80,80a8,8,0,0,1-11.32,0l-80-80A8,8,0,0,1,53.66,90.34L128,164.69l74.34-74.35a8,8,0,0,1,11.32,11.32Z"></path>
                    </svg>
                ...
                <p class="text-[#994d4d] text-sm font-normal leading-normal pb-2">We offer flexible cancellation policies. Full refunds are available for cancellations made 30+ days before departure. Cancellations made 15-29 days before receive 50% refund. We also offer travel insurance options for added protection.</p>
              </details>
              <details class="flex flex-col rounded-lg border border-[#e7d0d0] bg-[#fcf8f8] px-[15px] py-[7px] group">
                <summary class="flex cursor-pointer items-center justify-between gap-6 py-2">
                  <p class="text-[#1b0e0e] text-sm font-medium leading-normal">Do you offer group discounts?</p>
                  <div class="text-[#1b0e0e] group-open:rotate-180 transition-transform" data-icon="CaretDown" data-size="20px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor" viewBox="0 0 256 256">
                      <path d="M213.66,101.66l-80,80a8,8,0,0,1-11.32,0l-80-80A8,8,0,0,1,53.66,90.34L128,164.69l74.34-74.35a8,8,0,0,1,11.32,11.32Z"></path>
                    </svg>
                ...
                <p class="text-[#994d4d] text-sm font-normal leading-normal pb-2">Yes! We offer attractive discounts for groups of 6 or more people. The discount percentage increases with group size. Contact our group travel specialists for customized quotes and special arrangements for your group.</p>
              </details>
            </div>
          </div>
        </section>
...
{{-- <section id="hiring" class="flex justify-center py-5 bg-gradient-to-br from-[#e92929] to-[#d61f1f]">
  <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
      ...
      <div class="bg-white rounded-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
        <div class="flex items-start justify-between mb-4">
          <div>
            ...
            <p class="text-[#994d4d] text-sm">Full-time • Multiple Locations</p>
          </div>
          <span class="bg-[#e92929]/10 text-[#e92929] px-3 py-1 rounded-full text-xs font-medium">New</span>
        </div>
        <p class="text-[#994d4d] text-sm leading-relaxed mb-4">
        ...
        <button class="w-full bg-[#1b0e0e] text-white py-2 rounded-lg text-sm font-medium hover:bg-[#2b1e1e] transition-colors">
          Apply Now
        </button>
      </div>
      ...
      <div class="bg-white rounded-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
        <div class="flex items-start justify-between mb-4">
          <div>
            ...
            <p class="text-[#994d4d] text-sm">Full-time • Remote</p>
          </div>
      ...
      <div class="bg-white rounded-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
        <div class="flex items-start justify-between mb-4">
          <div>
            ...
            <p class="text-[#994d4d] text-sm">Part-time • Flexible</p>
          </div>
        </div>
        <p class="text-[#994d4d] text-sm leading-relaxed mb-4">
      ...
      <div class="bg-white rounded-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
        <div class="flex items-start justify-between mb-4">
          <div>
            ...
            <p class="text-[#994d4d] text-sm">Full-time • Office</p>
          </div>
        </div>
        <p class="text-[#994d4d] text-sm leading-relaxed mb-4">
      ...
      <div class="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
        ...
        <div class="grid md:grid-cols-3 gap-4 text-center">
          <div class="flex flex-col items-center">
            ...
            <p class="text-white/80 text-sm">Free and discounted tours for you and your family</p>
          </div>
          <div class="flex flex-col items-center">
            <div class="bg-white/20 rounded-full p-3 mb-2">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" viewBox="0 0 256 256">
            ...
            <p class="text-white/80 text-sm">Remote options and flexible schedules available</p>
          </div>
          <div class="flex flex-col items-center">
            <div class="bg-white/20 rounded-full p-3 mb-2">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" viewBox="0 0 256 256">
            ...
            <p class="text-white/80 text-sm">Work with passionate travel enthusiasts</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="text-center p-4 pb-8">
      <p class="text-white/90 text-sm mb-4">Don't see the perfect position? We're always looking for talented people!</p>
      <button class="bg-white text-[#e92929] px-6 py-3 rounded-lg font-bold hover:bg-[#fcf8f8] transition-colors">
        ...
        <section id="contact" class="flex justify-center py-12">
          <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
            <h2 class="text-[#1b0e0e] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">Contact Us</h2>
            <p class="text-[#1b0e0e] text-base font-normal leading-normal pb-3 pt-1 px-4">
              We're here to help! Whether you have questions about our tours, need assistance with booking, or just want to chat about your travel plans, feel free to reach out.
              Our team is dedicated to providing you with the best possible service and ensuring your experience with us is seamless and enjoyable.
            </p>
            <div class="grid md:grid-cols-2 gap-8 p-4">
                ...
                <div class="flex max-w-[480px] flex-wrap items-end gap-4 py-3">
                  <label class="flex flex-col min-w-40 flex-1">
                    <textarea
                      ...
                      class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-[#1b0e0e] focus:outline-0 focus:ring-0 border-none bg-[#f3e7e7] focus:border-none min-h-36 placeholder:text-[#994d4d] p-4 text-base font-normal leading-normal"
                    ></textarea>
                  </label>
                </div>
              ...
              <div>
                <h3 class="text-[#1b0e0e] text-lg font-bold leading-tight tracking-[-0.015em] pb-3">Our Details</h3>
                <div class="flex items-center gap-4 bg-[#fcf8f8] min-h-[72px] py-2">
                  <div class="text-[#1b0e0e] flex items-center justify-center rounded-lg bg-[#f3e7e7] shrink-0 size-12" data-icon="MapPin" data-size="24px" data-weight="regular">
                  ...
                  <div class="flex flex-col justify-center">
                    <p class="text-[#1b0e0e] text-base font-medium leading-normal line-clamp-1">Address</p>
                    <p class="text-[#994d4d] text-sm font-normal leading-normal line-clamp-2">123 Adventure Lane, Travel Town, 90210</p>
                  </div>
                </div>
                <div class="flex items-center gap-4 bg-[#fcf8f8] min-h-[72px] py-2">
                  <div class="text-[#1b0e0e] flex items-center justify-center rounded-lg bg-[#f3e7e7] shrink-0 size-12" data-icon="Phone" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
                  ...
                  <div class="flex flex-col justify-center">
                    <p class="text-[#1b0e0e] text-base font-medium leading-normal line-clamp-1">Phone</p>
                    <p class="text-[#994d4d] text-sm font-normal leading-normal line-clamp-2">+1 (555) 123-4567</p>
                  </div>
                </div>
                <div class="flex items-center gap-4 bg-[#fcf8f8] min-h-[72px] py-2">
                  <div class="text-[#1b0e0e] flex items-center justify-center rounded-lg bg-[#f3e7e7] shrink-0 size-12" data-icon="Envelope" data-size="24px" data-weight="regular">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path d="M224,48H32a8,8,0,0,0-8,8V192a16,16,0,0,0,16,16H216a16,16,0,0,0,16-16V56A8,8,0,0,0,224,48Zm-96,85.15L52.57,64H203.43ZM98.71,128,40,181.81V74.19Zm11.84,10.85,12,11.05a8,8,0,0,0,10.82,0l12-11.05,58,53.15H52.57ZM157.29,128,216,74.18V181.82Z"></path>
                    </svg>
                  </div>
                  <div class="flex flex-col justify-center">
                    <p class="text-[#1b0e0e] text-base font-medium leading-normal line-clamp-1">Email</p>
                    <p class="text-[#994d4d] text-sm font-normal leading-normal line-clamp-2">info@adventuretours.com</p>
                  </div>
                </div>
                <div class="flex gap-4 pt-4">
                  <a href="#" class="rounded-full bg-[#f3e7e7] p-2.5 hover:bg-[#e7d0d0] transition-colors">
                    <div class="text-[#1b0e0e]" data-icon="FacebookLogo" data-size="20px" data-weight="regular">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor" viewBox="0 0 256 256">
                        <path
                  ...
                  <a href="#" class="rounded-full bg-[#f3e7e7] p-2.5 hover:bg-[#e7d0d0] transition-colors">
                    <div class="text-[#1b0e0e]" data-icon="TwitterLogo" data-size="20px" data-weight="regular">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor" viewBox="0 0 256 256">
                        <path
                  ...
                  <a href="#" class="rounded-full bg-[#f3e7e7] p-2.5 hover:bg-[#e7d0d0] transition-colors">
                    <div class="text-[#1b0e0e]" data-icon="InstagramLogo" data-size="20px" data-weight="regular">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor" viewBox="0 0 256 256">
                        <path
        ...
        <footer class="flex justify-center bg-[#1b0e0e] text-white">
          <div class="flex max-w-[960px] flex-1 flex-col">
            <div class="flex flex-col gap-6 px-5 py-10 text-center @container">
              ...
              <p class="text-white text-sm font-normal leading-normal opacity-80">© 2024 Adventure Tours. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </div>
        ...
        toursGrid.innerHTML = tours.map(tour => `
          <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow cursor-pointer group">
            <div class="relative h-48 overflow-hidden">
              ...
              <div class="absolute top-4 right-4 bg-[#e92929] text-white px-3 py-1 rounded-full text-sm font-medium">
                ¥${tour.price.toLocaleString()}~
              </div>
            </div>
            <div class="p-4">
              <h3 class="text-[#1b0e0e] text-lg font-bold mb-2">${tour.title}</h3>
              <p class="text-[#994d4d] text-sm mb-3 line-clamp-2">${tour.description}</p>
              <div class="flex items-center justify-between mb-3">
                <div class="flex items-center gap-1">
                  ${generateStars(tour.rating)}
                  <span class="text-sm text-[#994d4d] ml-1">${tour.rating} (${tour.reviews})</span>
                </div>
              </div>
              <div class="flex items-center justify-between">
                <span class="text-sm text-[#994d4d]">
                ...
                <button class="bg-[#e92929] text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-[#d61f1f] transition-colors">
                  Book Now
                </button>
              </div>
            </div>
