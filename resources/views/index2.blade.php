                                    ...
                                    <div class="@[480px]:p-4">
                                          <div class="flex min-h-[480px] flex-col gap-6 bg-cover bg-center bg-no-repeat @[480px]:gap-8 @[480px]:rounded-lg items-center justify-center p-4"
                                                ...
                                                <div class="flex flex-col gap-2 text-center">
                                                      ...
                                                      <h2
                                                            class="text-white test-base font-normal leading-normal @[480px]:text-base @[480px]:font-normal @[480px]:leading-normal">
                                                            Step into old Japan with unforgettable tours crafted for
                                                            modern explorers.
                                                      </h2>
                                                </div>
                                                <a href="#tours"
                                                      class="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 @[480px]:h-12 @[480px]:px-5 bg-[#e92929] text-[#fcf8f8] test-base font-bold leading-normal tracking-[0.015em] @[480px]:text-base @[480px]:font-bold @[480px]:leading-normal @[480px]:tracking-[0.015em] hover:bg-[#d61f1f] transition-colors">
                        ...
                        <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
                              ...
                              <div id="destinations-section">
                                    ...
                                    <div class="flex flex-wrap gap-2 px-4 pb-3">
                                          ...
                                          {{-- <button class="filter-tab px-4 py-2 rounded-lg bg-[#f3e7e7] text-[#1b0e0e] test-base font-medium transition-all hover:bg-[#e7d0d0]" onclick="filterDestinations('kanto')">Kanto Region</button>
                <button class="filter-tab px-4 py-2 rounded-lg bg-[#f3e7e7] text-[#1b0e0e] test-base font-medium transition-all hover:bg-[#e7d0d0]" onclick="filterDestinations('kansai')">Kansai Region</button>
                <button class="filter-tab px-4 py-2 rounded-lg bg-[#f3e7e7] text-[#1b0e0e] test-base font-medium transition-all hover:bg-[#e7d0d0]" onclick="filterDestinations('other')">Other Regions</button> --}}
                                    </div>
